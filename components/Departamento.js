...
export default function Departamento({operacion, monedaOperacion, montoOperacion, 
    calle, altura, barrio, cantPisos, cantUnidades, cantAsensores, 
    pisoInmueble, Expensas, supTotal, 
    ...
    <div className={styles.datosInmueble}>
        ...
        <p>{`Ubicacion: ${calle} 
            ${altura} Piso ${pisoInmueble}`}</p>
        <p>{`Barrio: ${barrio}`}</p>
        <p>{`Cantidad de Pisos del Edificio: ${cantPisos}`}</p>
        <p>{`Cantidad de Unidades del Edificio: ${cantUnidades}`}</p>
        <p>{`Cantidad de Asensores del Edificio: ${cantAsensores}`}</p>
